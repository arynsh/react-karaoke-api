...
export function fetchSongId(title) {
    return function (dispatch) {
      ...
      return fetch('http://cors-anywhere.herokuapp.com/api.musixmatch.com/ws/1.1/track.search?&q_track=' + title + '&page_size=1&s_track_rating=desc&apikey=07d423bb8a12daed162457cdb9ccc3ea').then(
